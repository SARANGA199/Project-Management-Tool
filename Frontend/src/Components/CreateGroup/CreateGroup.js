...
const CreateGroup = () => {
  ...
  async function saveUser(e) {
    ...
    const promise = await axios
      .post("http://localhost:8070/members", data)
      .then((res) => {
        if ((res.status = 201)) {
          ...
          <form onSubmit={saveUser}>
            <div class="row">
              <div className="col-md-3">
                <label>
                  Group Leader Name : <font color="red">*</font>{" "}
                </label>
              ...
              <div className="col-md-3">
                <label>
                  Member 2 Name : <font color="red">*</font>{" "}
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 3 Name : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 4 Name : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
            ...
            <div class="row">
              <div className="col-md-3">
                <label>
                  Group Leader Student ID : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 2 Student ID : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 3 Student ID : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 4 Student ID : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
            ...
            <div class="row">
              <div className="col-md-3">
                <label>
                  Group Leader Email :<font color="red">*</font>{" "}
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 2 Email : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 3 Email : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
              ...
              <div className="col-md-3">
                <label>
                  Member 4 Email : <font color="red">*</font>
                </label>
                <div className="form-group">
                  <input
                    type="text"
