  ...
  return (
    <Routes>
      <Route
        exact
        path="/submitPre"
        element={isLogged ? <DisplaySubmitPresentation /> : <NotFound />}
      />
      <Route path="/add" element={isAdmin ? <AddMarking /> : <NotFound />} />
      <Route
        path="/evaluatePresentation"
        element={
          isAdmin || isPanelMember ? <EvaluatePresentation /> : <NotFound />
        }
      />
      <Route
        path="/presentationMarks"
        element={isLogged ? <DisplayPresentationMarks /> : <NotFound />}
      />
      <Route path="/topics" element={isLogged ? <Topics /> : <NotFound />} />
      <Route
        path="/acceptTopic"
        element={
          isSupervisor || isCoSupervisor ? <AcceptTopic /> : <NotFound />
        }
      />
      <Route
        path="/viewMarking"
        element={isLogged ? <ViewMarkingSchemes /> : <NotFound />}
      />
      <Route
        path="/updateMarking"
        element={isLogged ? <UpdateMarking /> : <NotFound />}
      />

      <Route
        path="/createGroup"
        element={isLogged ? <CreateGroup /> : <NotFound />}
      />
      <Route
        path="/groupList"
        element={isLogged ? <GroupList /> : <NotFound />}
      />
      <Route
        path="/topicRegister"
        element={isLogged ? <TopicRegister /> : <NotFound />}
      />
      <Route
        path="/requestSupervisor"
        element={isLogged ? <RequestSupervisor /> : <NotFound />}
      />
      <Route
        path="/stdSubmitDoc"
        element={isLogged ? <StdSubmitDoc /> : <NotFound />}
      />
      <Route
        path="/topicSubmitDoc"
        element={isLogged ? <TopicSubmitDoc /> : <NotFound />}
      />
      <Route
        path="/displayRequests"
        element={isLogged ? <DisplayRequests /> : <NotFound />}
      />
      <Route
        path="/updateSupervisorStatus"
        element={isLogged ? <UpdateSupervisorStatus /> : <NotFound />}
      />
      <Route
        path="/requestCoSupervisor"
        element={isLogged ? <RequestCoSupervisor /> : <NotFound />}
      />
      <Route
        path="/displayCoSupervisors"
        element={isLogged ? <DisplayCoSupervisors /> : <NotFound />}
      />
      <Route
        path="/updateCoSupervisorStatus"
        element={isLogged ? <UpdateCoSupervisorStatus /> : <NotFound />}
      />

      <Route
        path="/addTemplate"
        element={isLogged ? <TemplateForm /> : <NotFound />}
      />
      <Route
        path="/display"
        element={isLogged ? <Displaytemplate /> : <NotFound />}
      />
      <Route
        path="/AddSubType"
        element={isAdmin ? <AddSubmissiontype /> : <NotFound />}
      />
      <Route
        path="/displaysub"
        element={isLogged ? <DisplaysubType /> : <NotFound />}
      />
      <Route
        path="/updateSub"
        element={isLogged ? <UpdateSubmissionType /> : <NotFound />}
      />
      ...
      <Route
        path="/allusers"
        element={isLogged ? <AllUsers /> : <NotFound />}
      />
      <Route
        path="/PendingUsers"
        element={isAdmin ? <PendingUsers /> : <NotFound />}
      />
      <Route
        path="/updateuser/:id"
        element={isLogged ? <UpdateUser /> : <NotFound />}
      />
      <Route
      ...
      <Route
        ...
        element={
          isAdmin || isSupervisor || isCoSupervisor ? (
            <DocumentEvaluation />
          ) : (
            <NotFound />
          )
      ...
      <Route
        path="/submitdocs"
        element={isLogged ? <DisplaySubmitDocuments /> : <NotFound />}
      />
      <Route
        path="/documentmarks"
        element={isLogged ? <DisplayDocumentMarks /> : <NotFound />}
      />

      <Route
        path="/evaluateTopic"
        element={isLogged ? <TopicEvaluate /> : <NotFound />}
      />
      <Route
        path="/AddPanelMember"
      ...
      <Route
        path="/oneForum"
        element={isLogged ? <DisplayOneForum /> : <NotFound />}
      />
      <Route
        path="/editReply"
        element={isLogged ? <UpdateReply /> : <NotFound />}
      />
      <Route
        path="/editChatForum"
        element={isLogged ? <UpdateChatForum /> : <NotFound />}
      />
      <Route
        path="/allForums"
        element={isLogged ? <DisplayAllForums /> : <NotFound />}
      />
      <Route
        path="/addPanelMember"
        element={isLogged ? <AddPanelMember /> : <NotFound />}
